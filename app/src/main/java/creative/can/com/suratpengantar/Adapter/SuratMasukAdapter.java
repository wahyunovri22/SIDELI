...
public class SuratMasukAdapter extends RecyclerView.Adapter<SuratMasukAdapter.SuratHolder> {

    private List<SuratMenungguDiketahui> dataModels;
    private Context context;
    //private SuratMasukAdapter adapter;

    public SuratMasukAdapter( Context context, List<SuratMenungguDiketahui> dataModels) {
                ...
                public void onClick(View view) {
                    ...
                    builder.setItems(dialogItem, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            String mStatus = "WAITING_APPROVE_RT";
