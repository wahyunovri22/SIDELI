package creative.can.com.suratpengantar.ActivityRW;
...
public class HomeRWActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_rw);
...
/*View view=navigationView.inflateHeaderView(R.layout.nav_header_main);*/
        ...
        posisiku.setText(config.getSpPosisirw());

        FragmentManager manajer = getSupportFragmentManager();
        manajer.beginTransaction()
                .replace(R.id.layout_content_rw, new NewsFragment())
                .commit();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.home_rw, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profil) {
            ...
            FragmentManager manajer = getSupportFragmentManager();
            manajer.beginTransaction()
                    .replace(R.id.layout_content_rw, new HistoryRWFragment())
                    .commit();
    ...
    public final Runnable runnable = new Runnable() {
        ...
        public void run() {
            nama.setText(config.getSPNama());
            nik.setText(config.getSpId());
            HomeRWActivity.this.handler.postDelayed(runnable, 3000);
        }
    };
}
