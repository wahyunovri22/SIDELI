...
public class SuratKetUsahaActivity extends AppCompatActivity {
    ...
    private LinearLayout layoutUsaha;
    private MaterialEditText edtJenisUsaha;
    private MaterialEditText edtLokasiUsaha;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surat_ket_usaha);
        initView();
...
//        });
    ...
    private void initView() {
        ...
        layoutUsaha = (LinearLayout) findViewById(R.id.layout_usaha);
        edtJenisUsaha = (MaterialEditText) findViewById(R.id.edt_jenis_usaha);
        edtLokasiUsaha = (MaterialEditText) findViewById(R.id.edt_lokasi_usaha);
    ...
    public void awal() {
        ...
        edtNamaSurat.setText("Surat Keterangan Usaha");
        edtNamaSurat.setFocusable(false);
        edtIdSurat.setText("6");
    ...
    public Boolean validasi(){
        ...
        if (edtKeperluan.getText().toString().isEmpty()){
            ...
            return false;
        }if (edtJenisUsaha.getText().toString().isEmpty()){
            edtJenisUsaha.setError("Harus diisi");
            edtJenisUsaha.requestFocus();
            return false;
        }if (edtLokasiUsaha.getText().toString().isEmpty()){
            edtLokasiUsaha.setError("Harus diisi");
            edtLokasiUsaha.requestFocus();
            return false;
        }
        return true;
    }
    ...
    public void daftar() {
        ...
        String usaha = edtJenisUsaha.getText().toString();
        String lokasi = edtLokasiUsaha.getText().toString();
        pd.setMessage("loading");
        pd.setCancelable(false);
        pd.show();

        ApiRequest apiRequest = RetrofitConfig.getRetrofit().create(ApiRequest.class);
        Call<ResponseModel> get = apiRequest.insertSuratUsaha(id, keperluan, status, nik2, kk, nama, tempatlahir, tgl,
                jk, alamat, rt, rw, kelurahan, kecamatan, kabupaten, provinsi, agama, status_nikah, status_kk, pendidikan,
                pekerjaan, penduduk,usaha,lokasi);
